...
=======
        => optionsBuilder.UseSqlServer("Server=21AK22-COM\\NGUYENVANAN;Database=QuanLyBanVeXemPhim;Trusted_Connection=True;MultipleActiveResultSets=True;TrustServerCertificate=True;");
